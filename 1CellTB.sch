...
C {devices/ipin.sym} 590 350 0 0 {name=p5 lab=WriteForm_Select}
...
C {devices/iopin.sym} 1110 200 3 0 {name=p10 lab=VSS}
C {devices/ipin.sym} 470 720 0 0 {name=p17 lab=LA_IN_Source}
C {devices/ipin.sym} 470 750 0 0 {name=p18 lab=WriteForm_Select}
C {devices/iopin.sym} 880 590 3 0 {name=p19 lab=VDD18}
C {devices/iopin.sym} 1220 700 3 0 {name=p20 lab=VDD18}
C {devices/iopin.sym} 880 670 2 0 {name=p14 lab=VSS}
C {devices/iopin.sym} 880 780 2 0 {name=p11 lab=VSS}
C {devices/iopin.sym} 880 700 2 0 {name=p13 lab=VDD25}
C {devices/iopin.sym} 1220 780 2 0 {name=p12 lab=VSS}
